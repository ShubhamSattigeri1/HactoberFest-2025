"""
hello one this is a small mini project whwre once you enter you details this platform creates a QR 
code which you can use for networking and other purposes.

This was just a mini project due to which i did not add regex.
"""
...
#reads a file’s raw binary data and converts it into a Base64 text string
...
#this sets the background of our website 
...
#Front end model css is being used here
st.markdown(f"""
    <style>
    .stApp {{
...
#From here begins the core of the code OG python begins
#this is the class which takes inputs form users to generate qr code
class Portfolio:
    def __init__(self):
...
# Some exceptions to handle are necesarry 
